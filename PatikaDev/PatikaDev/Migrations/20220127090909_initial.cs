    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PassingGrade = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssistantCourse", x => new { x.AssistantsId, x.CoursesId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_AssistantCourse_Courses_CoursesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseParticipant", x => new { x.CoursesId, x.ParticipantsId });
                    table.ForeignKey(
                        name: "FK_CourseParticipant_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseParticipant_Participants_ParticipantsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseAbsences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourseAbsences_CourseStudents_CourseStudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grades_CourseStudents_CourseStudentId",
                        column: x => x.CourseStudentId,
                        principalTable: "CourseStudents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssistantCourse_CoursesId",
                table: "AssistantCourse",
                column: "CoursesId");

            migrationBuilder.CreateIndex(
                name: "IX_CourseAbsences_CourseStudentId",
                table: "CourseAbsences",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseParticipant_ParticipantsId",
